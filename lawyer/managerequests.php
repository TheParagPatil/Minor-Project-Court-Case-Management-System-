...
if ($con) {
	$x = 1;
	$stmt = $con->prepare("SELECT `clientforcase_id`, `clientforcase_id`, case_type, `case_details` FROM cases WHERE `lawyer_id_assigned` = '1' AND `lawyer_status` = 'not yet accepted'");
